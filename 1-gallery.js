...
`).join("");document.addEventListener("DOMContentLoaded",()=>{const t=document.querySelector(".gallery");t.innerHTML=l,t.style.cssText=`
  ...
  `,document.head.appendChild(n);const i=document.createElement("style");i.innerHTML=`
  ...
  `,document.head.appendChild(i);const p=document.createElement("style");p.innerHTML=`
    .sl-counter {
      color: #ffffff !important;
      font-size: 16px;
      font-weight: 400;
